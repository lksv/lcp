  ...
  module ViewSlots
    class Registry
      BUILT_IN_COMPONENTS = [
        ...
        { page: :index, slot: :below_content,  name: :per_page_selector,  partial: "lcp_ruby/slots/index/per_page_selector",   position: 5,
          enabled: ->(ctx) { ctx.presenter.per_page_options.is_a?(Array) } },
