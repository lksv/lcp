define_presenter :saved_filters do
  ...
  form do
    section "Filter Details", columns: 2 do
      ...
      field :target_presenter, placeholder: "e.g. deals"
      field :visibility, input_type: :select
    end

    section "Targeting", columns: 2 do
      field :target_role, placeholder: "e.g. sales_rep"
      field :target_group
    end
    ...
    section "Display", columns: 2 do
      ...
      field :icon, placeholder: "e.g. trending-up"
      field :color, placeholder: "e.g. green"
    end
  end
