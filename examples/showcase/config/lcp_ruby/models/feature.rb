define_model :feature do
  ...
  field :category, :enum, label: "Category", null: false,
    values: %w[field_types display_types input_types model_features presenter form permissions role_source extensibility navigation attachments authentication] do
    validates :presence
  end
