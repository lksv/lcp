...
- [x] Condition combinations (AND / OR groups with recursive nesting, configurable `max_nesting_depth`, no NOT nesting) — visual filter builder with nested AND/OR tree
