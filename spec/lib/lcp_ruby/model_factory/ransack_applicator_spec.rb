...
RSpec.describe LcpRuby::ModelFactory::RansackApplicator do
  ...
  describe "ransackable_attributes" do
    ...
    it "returns readable fields with PermissionEvaluator auth_object" do
  ...
  describe "ransackable_associations" do
    ...
    it "filters by FK readability with PermissionEvaluator" do
      evaluator = instance_double(LcpRuby::Authorization::PermissionEvaluator)
      allow(evaluator).to receive(:is_a?)
        .with(LcpRuby::Authorization::PermissionEvaluator)
        .and_return(true)
    ...
    it "excludes associations when FK is not readable" do
      evaluator = instance_double(LcpRuby::Authorization::PermissionEvaluator)
      allow(evaluator).to receive(:is_a?)
        .with(LcpRuby::Authorization::PermissionEvaluator)
        .and_return(true)
